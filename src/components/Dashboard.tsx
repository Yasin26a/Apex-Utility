...
export const DEFAULT_CARDS: DashboardCard[] = [
  ...
  {
    id: 'visual-pdf-organizer',
    title: 'Visual PDF Page Organizer',
    desc: 'Upload any PDF, view individual page thumbnails in an interactive grid, drag and drop to reorder, click to rotate, and delete unwanted pages.',
    tagline: '"reorder, rotate, and prune pdf pages visually"',
    category: 'PDF Editor',
    categoryIcon: 'Layers',
    cardIcon: 'Layers',
    textClass: 'text-emerald-400 font-bold',
    buttonLabel: 'Launch Visual Organizer',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'pdf-unlocker',
    title: 'Instant PDF Unlocker',
    desc: 'Stuck with a restricted PDF? Instantly strip copy, print, and modification locks online for free. 100% private and offline decryption.',
    tagline: '"unlock restricted pdf free instant"',
    category: 'PDF Editor',
    categoryIcon: 'Layers',
    cardIcon: 'Unlock',
  ...
  {
    id: 'pdf-redactor',
    title: 'Client-Side PDF PII Redactor & Masker',
    desc: 'Automatically detect and blackout sensitive SSNs, credit cards, emails, phone numbers, and custom secret keywords in PDFs 100% offline.',
    tagline: '"blackout sensitive pdf data, client side pdf redactor, redact ssn and credit card in pdf free"',
    category: 'PDF Editor',
    categoryIcon: 'Layers',
    cardIcon: 'ShieldCheck',
    textClass: 'text-amber-400 font-bold',
    buttonLabel: 'Launch PDF Redactor',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'freelance-rate-estimator',
    title: 'Freelance Rate & Tax Retention Estimator',
    desc: 'Calculates target billable hourly rates based on business expenses, desired profit margin, billable capacity, and Tier-1 self-employment tax structures.',
    tagline: '"freelance hourly rate calculator, self employment tax estimator, tax retention rate freelancer, billable rate profit margin"',
    category: 'Calculators',
    categoryIcon: 'Scale',
    cardIcon: 'Calculator',
    textClass: 'text-emerald-400 font-bold',
    buttonLabel: 'Calculate Freelance Rates',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'mortgage-refinance-visualizer',
    title: 'Mortgage Refinance & Amortization Visualizer',
    desc: 'Compare loan refinancing savings, P&I schedules, tax deduction savings, points & closing costs, and interactive break-even payoff timelines.',
    tagline: '"mortgage refinance calculator, amortization schedule visualizer, principal vs interest graph, mortgage tax deduction savings, refinance break even"',
    category: 'Calculators',
    categoryIcon: 'Scale',
    cardIcon: 'Scale',
    textClass: 'text-cyan-400 font-bold',
    buttonLabel: 'Visualize Mortgage Savings',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'svg-pattern-architect',
    title: 'SVG Pattern & Wave Architect',
    desc: 'Architect fluid multi-layered SVG waves, mesh gradients, isometric grids, and tileable geometric UI background patterns with CSS & SVG exports.',
    tagline: '"svg wave generator, mesh gradient generator, geometric pattern maker, tileable background patterns, css svg background"',
    category: 'Graphics & Design',
    categoryIcon: 'Palette',
    cardIcon: 'Palette',
    textClass: 'text-cyan-400 font-bold',
    buttonLabel: 'Launch Pattern Studio',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'schema-rich-snippet-builder',
    title: 'Schema.org Rich Snippet Builder',
    desc: 'Visual Schema.org JSON-LD structured data generator for FAQ, Article, Product, HowTo, and Local Business with real-time Google Rich Results validation and SERP preview.',
    tagline: '"schema markup generator, google rich snippet tester, json ld builder, structured data schema org, faq article product schema"',
    category: 'SEO Suite',
    categoryIcon: 'Globe',
    cardIcon: 'FileCode',
    textClass: 'text-amber-400 font-bold',
    buttonLabel: 'Build Schema Markup',
    colSpan: 1,
    heightLevel: 2
  },
  {
  ...
  {
    id: 'rest-playpen',
    title: 'REST API Playpen',
    desc: 'Lightweight browser-based API client. Test endpoints, configure custom headers, configure JSON body or form payloads, use proxy bypass, and inspect responses.',
    tagline: '"simplified browser postman, client side rest client, testing api endpoints online"',
    category: 'Developer Operations',
    categoryIcon: 'Braces',
    cardIcon: 'Terminal',
    textClass: 'text-violet-400 font-bold',
    buttonLabel: 'Launch API Playpen',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'markdown-compiler',
    title: 'Markdown & LaTeX Live Compiler',
    desc: 'An interactive split-pane WYSIWYG editor compiling standard Markdown, GFM elements, checklists, and complex LaTeX math equations with auto-save.',
    tagline: '"real time markdown editor, online latex compiler, github flavored markdown sandbox"',
    category: 'Document & Editing Utilities',
    categoryIcon: 'FileText',
    cardIcon: 'FileText',
    textClass: 'text-emerald-400 font-bold',
    buttonLabel: 'Launch Markdown Editor',
    colSpan: 1,
    heightLevel: 2
  },
  {
  ...
  {
    id: 'ai-content-brief',
    title: 'AI Content Brief & Outline Generator',
    desc: 'Design search-optimized heading outlines, specify target intent, track LSI keywords, and generate complete section draft content powered by Gemini.',
    tagline: '"premium seo heading brief & draft generator"',
    category: 'AI Copywriting',
    categoryIcon: 'Sparkles',
    cardIcon: 'Sparkles',
    textClass: 'text-red-400 font-bold',
    buttonLabel: 'Launch Brief Generator',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'social-hooks',
    title: 'AI Social Media Hook Generator',
    desc: 'Generate viral, high-engagement hooks for Twitter/X threads, LinkedIn posts, or YouTube scripts based on custom topic, audience, and emotional tone.',
    tagline: '"viral social media algorithms, psychological trigger hooks, post mockups"',
    category: 'AI Copywriting',
    categoryIcon: 'Sparkles',
    cardIcon: 'Sparkles',
    textClass: 'text-purple-400 font-bold',
    buttonLabel: 'Generate Social Hooks',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'code-explainer',
    title: 'AI Code Explainer & Translator',
    desc: 'Explain confusing legacy scripts line-by-line, run theoretical Big O time/space analyses, or translate code blocks across programming languages with direct structural mapping annotations.',
    tagline: '"legacy scripts reverse-engineering, Big O algorithm complexites, logic compiler"',
    category: 'AI Copywriting',
    categoryIcon: 'Sparkles',
    cardIcon: 'Code2',
    textClass: 'text-indigo-400 font-bold',
    buttonLabel: 'Explain & Translate Code',
    colSpan: 1,
    heightLevel: 2
  },
  {
    ...
    tagline: '"image alt text generator, accessibility compliance, seo filename optimizer"',
    category: 'AI Copywriting',
    categoryIcon: 'Sparkles',
    cardIcon: 'Sparkles',
    textClass: 'text-indigo-400 font-bold',
    buttonLabel: 'Generate Alt-Text',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'keyword-difficulty',
    title: 'SEO Keyword Difficulty Analyzer',
    desc: 'Calculate organic search competition metrics, assess search intent profiles, map monthly trend indicators, and review top simulated competitor rankings.',
    tagline: '"keyword difficulty checker, keyword competition tool, serp analyzer"',
    category: 'AI Copywriting',
    categoryIcon: 'Sparkles',
    cardIcon: 'Target',
    textClass: 'text-indigo-400 font-bold',
  ...
  {
    id: 'url-slugifier',
    title: 'SEO URL Slugifier & Link Architect',
    desc: 'Convert raw post titles into clean, keyword-focused, search-optimized URL slugs in real-time or with neural AI analysis and technical structural report card.',
    tagline: '"url slugifier, url builder, permalink creator"',
    category: 'AI Copywriting',
    categoryIcon: 'Sparkles',
    cardIcon: 'Link',
    textClass: 'text-indigo-400 font-bold',
    buttonLabel: 'Build Slugs',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'meta-tag-auditor',
    title: 'Meta Tag Auditor & Card Architect',
    desc: 'Audit webpages for missing OpenGraph tags, incorrect canonical links, and viewport specifications with comprehensive report card and visual sharing previews.',
    tagline: '"meta tag auditor, opengraph checker, viewport validator, link auditor"',
    category: 'AI Copywriting',
    categoryIcon: 'Sparkles',
    cardIcon: 'Layers',
    textClass: 'text-indigo-400 font-bold',
    buttonLabel: 'Audit Meta Tags',
    colSpan: 1,
    heightLevel: 2
  },
  {
  ...
  {
    id: 'redirect-auditor',
    title: 'Redirect Chain & HTTP Header Auditor',
    desc: 'Audit complete URL redirection chains (301, 302, JS, Meta), response headers, latency times, and critical security headers (HSTS, CSP) instantly.',
    tagline: '"track redirection path, security headers, and SEO redirect chains"',
    category: 'AI Copywriting',
    categoryIcon: 'Sparkles',
    cardIcon: 'ShieldCheck',
    textClass: 'text-rose-400 font-bold',
    buttonLabel: 'Launch Redirect Auditor',
    colSpan: 1,
    heightLevel: 2
  },
  {
    ...
    desc: 'Simulate pixel-perfect Google Search results on desktop and mobile in real-time. Tune title tags, meta descriptions, star ratings, and custom rich snippets with length audits.',
    tagline: '"simulate Google search snippet, character and pixel tracker, rich snippets"',
    category: 'AI Copywriting',
    categoryIcon: 'Sparkles',
    cardIcon: 'Eye',
    textClass: 'text-emerald-400 font-bold',
    buttonLabel: 'Preview Google Snippets',
    colSpan: 1,
    heightLevel: 2
  },
  {
  ...
  },
  {
    ...
    desc: 'Format raw, unreadable SQL queries (PostgreSQL, MySQL, SQLite, T-SQL, PL/SQL) into beautifully indented, syntax-highlighted blocks, or minify them for compact database logging.',
    tagline: '"beautify SQL statements, custom indent casing dialects, optimize database query logs"',
    category: 'Design & Signals',
    categoryIcon: 'Database',
    cardIcon: 'Database',
    textClass: 'text-emerald-400 font-bold',
    buttonLabel: 'Format SQL Queries',
    colSpan: 1,
    heightLevel: 2
  },
  {
    ...
    desc: 'Input an IP address and a subnet mask to calculate network ranges, host limits, broadcast addresses, and wildcard masks instantly.',
    tagline: '"calculate IPv4 subnet CIDR ranges, wildcard masks, plan network sub-allocations"',
    category: 'Design & Signals',
    categoryIcon: 'Network',
    cardIcon: 'Network',
    textClass: 'text-emerald-400 font-bold',
    buttonLabel: 'Calculate Subnets',
    colSpan: 1,
    heightLevel: 2
  },
  {
    ...
    desc: 'Visually design clean organic SVG waves, multi-layered ripples, sharp steps, or geometric slants. Customize color gradients and download production-ready code.',
    tagline: '"custom page section separator graphics, fluid vectors, background layout generators"',
    category: 'Design & Signals',
    categoryIcon: 'Layout',
    cardIcon: 'Layout',
    textClass: 'text-emerald-400 font-bold',
    buttonLabel: 'Generate SVG Waves',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'box-shadow',
    title: 'CSS Box-Shadow & Bento Grid Previewer',
    desc: 'Visually craft advanced multi-layered, smooth ambient shadows, diffused depths, or brutalist frames. Preview on responsive Bento grids and generate clean CSS and Tailwind configurations.',
    tagline: '"smooth diffused ambient depth shaders, layered shadows, glassmorphism filters"',
    category: 'Design & Signals',
    categoryIcon: 'Layers',
    cardIcon: 'Layers',
    textClass: 'text-emerald-400 font-bold',
    buttonLabel: 'Design Box-Shadows',
    colSpan: 1,
    heightLevel: 2
  },
  {
  ...
  {
    id: 'case-converter',
    title: 'Case Converter & Duplicate Remover',
    desc: 'Free online case converter, text formatter, and duplicate text remover. Convert sentence case online, remove duplicate lines or duplicate words, remove commas, convert word to text, and clean text online instantly.',
    tagline: '"duplicate checker online, online duplicate remover, case converter online, sentence case online free"',
    category: 'Developer Operations',
    categoryIcon: 'Braces',
    cardIcon: 'Type',
    textClass: 'text-sky-400',
  ...
  {
    id: 'tailwind-grid',
    title: 'Tailwind Grid & Layout Visualizer',
    desc: 'An interactive developer sandbox to design, preview, and test custom CSS grids and layouts across multiple responsive breakpoints with clean copyable Tailwind utility classes.',
    tagline: '"tailwind grid generator, responsive breakpoints layout visualizer"',
    category: 'Design & Signals',
    categoryIcon: 'Palette',
    cardIcon: 'Sliders',
    textClass: 'text-amber-400',
    buttonLabel: 'Visualize Grid Layouts',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'clip-path',
    title: 'CSS Clip-Path Polygon Architect',
    desc: 'A visual vector design sandbox allowing you to drag polygon vertices, define custom clipping shapes, toggle preset structures, and copy perfect CSS/Tailwind clip-path codes.',
    tagline: '"css clip-path builder, polygon vertex editor, shape clipping generator"',
    category: 'Design & Signals',
    categoryIcon: 'Palette',
    cardIcon: 'Crop',
    textClass: 'text-rose-400',
    buttonLabel: 'Design Clip-Paths',
    colSpan: 1,
    heightLevel: 2
  },
  {
  ...
  {
    id: 'screen-recorder',
    title: 'Screen Recorder – Record Browser & Desktop Free',
    desc: 'Capture full browser windows, dedicated applications, or custom display outputs with audio streams offline.',
    tagline: '"free screen recorder online no install"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Monitor',
    textClass: 'text-cyan-400',
    buttonLabel: 'Launch Screen Recorder',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'webcam-recorder',
    title: 'Webcam Recorder – Record Video Online',
    desc: 'Record video from your camera and audio from microphone in full high-definition offline.',
    tagline: '"record webcam online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Camera',
    textClass: 'text-rose-400',
    buttonLabel: 'Launch Webcam Recorder',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'voice-recorder',
    title: 'Voice Recorder – Record Audio & Mic Free',
    desc: 'Capture lossless raw microphone audio and export as WAV/MP3 files instantly offline.',
    tagline: '"record voice online mic free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Mic',
    textClass: 'text-amber-400',
    buttonLabel: 'Launch Voice Recorder',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'video-compressor',
    title: 'Video Compressor – Compress Video Online Free',
    desc: 'Reduce file size of MP4, WebM, and MOV videos with configurable targets client-side.',
    tagline: '"compress video size online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Shrink',
    textClass: 'text-violet-400',
    buttonLabel: 'Launch Compressor',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'video-resizer',
    title: 'Video Resizer – Change Aspect Ratio',
    desc: 'Crop, resize, and fit video files into standard aspect ratios (16:9, 9:16, 1:1, 4:3) completely local.',
    tagline: '"change video aspect ratio online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Maximize',
    textClass: 'text-pink-400',
    buttonLabel: 'Launch Resizer',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'video-cutter',
    title: 'Video Cutter & Trimmer – Trim Video Online',
    desc: 'Cut specific segments, trim timeline boundaries, and export trimmed video segments.',
    tagline: '"trim video cutter online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Scissors',
    textClass: 'text-sky-400',
    buttonLabel: 'Launch Cutter',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'mute-video',
    title: 'Mute Video – Strip Audio Track Free',
    desc: 'Strip sound and remove background audio channels from video clips instantly offline.',
    tagline: '"remove audio from video online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'VolumeX',
    textClass: 'text-red-400',
  ...
  {
    id: 'video-speed',
    title: 'Video Speed Controller – Fast & Slow Motion',
    desc: 'Accelerate or slow down video playback speed from 0.25x to 4x and export speed-adjusted videos.',
    tagline: '"change video speed online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Gauge',
    textClass: 'text-emerald-400',
    buttonLabel: 'Adjust Video Speed',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'video-rotator',
    title: 'Video Rotator & Flipper – Rotate Video',
    desc: 'Rotate videos 90, 180, 270 degrees or flip horizontally and vertically in sandbox.',
    tagline: '"rotate video online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'RotateCw',
    textClass: 'text-amber-400',
  ...
  {
    id: 'video-merger',
    title: 'Video Merger – Combine Clips Online Free',
    desc: 'Join and compile multiple video clips into a single continuous file sequentially.',
    tagline: '"merge videos online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Plus',
    textClass: 'text-indigo-400',
  ...
  {
    id: 'video-converter',
    title: 'Video Converter – WEBM/MOV/MKV to MP4',
    desc: 'Convert multiple video file formats securely within the client sandbox.',
    tagline: '"convert webm to mp4 online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'ArrowRightLeft',
    textClass: 'text-orange-400',
    buttonLabel: 'Launch Converter',
    colSpan: 1,
    heightLevel: 2
  },
  {
    ...
    desc: 'Extract frames and transcode videos into beautiful compact loopable animated GIFs.',
    tagline: '"convert video to gif online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Film',
    textClass: 'text-fuchsia-400',
  ...
  {
    id: 'video-to-mp3',
    title: 'Video to MP3 Extractor – Extract Audio Track',
    desc: 'Strip audio out of video clips and convert them into standard audio channels.',
    tagline: '"extract audio from video mp3 online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Music',
  ...
  {
    id: 'audio-converter',
    title: 'Audio Format Converter – MP3/WAV/OGG/M4A',
    desc: 'Convert between popular audio formats with high fidelity completely locally.',
    tagline: '"convert wav to mp3 online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'ArrowRightLeft',
    textClass: 'text-cyan-400',
  ...
  },
  {
    ...
    title: 'Subtitle Format Converter – SRT to VTT',
    desc: 'Convert SRT subtitle text structures into standard WEBVTT formats dynamically.',
    tagline: '"convert srt to vtt online free"',
    category: 'Media Lab',
    categoryIcon: 'Video',
    cardIcon: 'Type',
    textClass: 'text-amber-400',
    buttonLabel: 'Convert Subtitles',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'microphone-tester',
    title: 'Microphone Tester – Check Mic Level',
    desc: 'Check microphone capture volume levels with real-time decibel level meters.',
    tagline: '"mic test online check level"',
    category: 'Developer Operations',
    categoryIcon: 'Braces',
    cardIcon: 'Mic',
    textClass: 'text-rose-400',
    buttonLabel: 'Test Microphone',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'webcam-check',
    title: 'Webcam Check – Hardware Tester',
    desc: 'Audit camera resolutions, check frame rate supports, and capture safe preview snapshots.',
    tagline: '"webcam test check resolution"',
    category: 'Developer Operations',
    categoryIcon: 'Braces',
    cardIcon: 'Video',
    textClass: 'text-teal-400',
    buttonLabel: 'Check Webcam',
    colSpan: 1,
    heightLevel: 2
  },
  {
    id: 'speaker-tester',
    title: 'Speaker Tester – Channel & Frequency Check',
    desc: 'Check stereo channel pan outputs and run high-frequency sweeping sine wave tones.',
    tagline: '"speaker test check left right"',
    category: 'Developer Operations',
    categoryIcon: 'Braces',
    cardIcon: 'Volume2',
    textClass: 'text-sky-400',
    buttonLabel: 'Test Speakers',
    colSpan: 1,
    heightLevel: 2
  }
];
  ...
  const getTranslatedTagline = (cardId: string, defaultTagline: string, lang: string): string => {
    const dicts: Record<string, Record<string, string>> = {
      en: {
        ...
        'visual-pdf-organizer': "reorder, rotate, and prune pdf pages visually",
        'pdf-unlocker': "unlock restricted pdf free instant",
        ...
        'ai-content-brief': "design heading outlines, track lsi keywords and generate article section content drafts with ai",
        'social-hooks': "generate high-engagement, viral hooks for Twitter/X threads, LinkedIn posts, or YouTube scripts",
        'code-explainer': "explain legacy scripts line-by-line or translate code blocks across programming languages with annotations",
        'favicon-generator': "generate cross-platform favicons (16x16, 32x32, 192x192, 512x512) and customize complete webmanifest specifications instantly",
        'alt-text-generator': "audit image assets to generate descriptive, accessible, and search-optimized alternative text descriptions",
        'keyword-difficulty': "calculate organic search difficulty, search intent classification, and simulated SERP competitors metrics",
        'url-slugifier': "convert raw post titles into clean, keyword-focused, search-optimized URL slugs instantly",
        'meta-tag-auditor': "audit webpage metadata, canonical links, viewport responsive tags and generate rich visual social preview cards",
      ...
      es: {
        ...
        'social-hooks': "genere ganchos virales de alto compromiso para hilos de Twitter/X, publicaciones de LinkedIn o guiones de YouTube",
        'code-explainer': "explique scripts heredados línea por línea o traduzca bloques de código entre lenguajes de programación con anotaciones",
        'favicon-generator': "genere favicons multiplataforma (16x16, 32x32, 192x192, 512x512) y personalice especificaciones de webmanifest de forma instantánea",
        'alt-text-generator': "audite imágenes para generar descripciones de texto alternativo optimizadas para seo y accesibilidad",
        'keyword-difficulty': "calcule la dificultad de búsqueda orgánica, la clasificación de la intención de búsqueda y las métricas de competidores de SERP simuladas",
        'url-slugifier': "convierta títulos de publicaciones en slugs de URL limpios, optimizados para palabras clave y motores de búsqueda",
        'meta-tag-auditor': "audite los metadatos de las páginas web, los enlaces canónicos, las etiquetas de diseño adaptable y genere tarjetas de vista previa social",
      ...
      fr: {
        ...
        'social-hooks': "générez des accroches virales à fort engagement pour les threads Twitter/X, les publications LinkedIn ou les scripts YouTube",
        'code-explainer': "expliquez les scripts hérités ligne par ligne ou traduisez des blocs de code entre langages avec des annotations",
        'favicon-generator': "générez des favicons multiplateformes (16x16, 32x32, 192x192, 512x512) et personnalisez les spécifications webmanifest instantanément",
        'alt-text-generator': "auditez des images pour générer du texte alternatif optimisé pour le référencement et l'accessibilité",
        'keyword-difficulty': "calculez la difficulté de recherche organique, la classification de l'intention et analysez les concurrents SERP simulés",
        'url-slugifier': "convertissez instantanément les titres de publications en slugs d'URL propres et optimisés pour le référencement",
        'meta-tag-auditor': "auditez les métadonnées des pages web, les liens canoniques, les configurations de viewport et générez des cartes de prévisualisation enrichies",
      ...
      de: {
        ...
        'social-hooks': "generieren sie virale, reichweitenstarke Hooks für Twitter/X-Threads, LinkedIn-Beiträge oder YouTube-Skripte",
        'code-explainer': "erklären sie legacy-skripte zeile für zeile oder übersetzen sie code-blöcke mit anmerkungen in andere sprachen",
        'favicon-generator': "generieren sie plattformübergreifende favicons (16x16, 32x32, 192x192, 512x512) und konfigurieren sie webmanifests sofort",
        'alt-text-generator': "überprüfen sie bilder, um seo- und barrierefreiheits-optimierte alt-texte zu generieren",
        'keyword-difficulty': "berechnen sie die organische keyword-schwierigkeit, suchintent-klassifizierung und simulierte serp-metriken",
        'url-slugifier': "konvertieren Sie rohe Beitragstitel sofort in saubere, keyword-fokussierte und suchmaschinenoptimierte URL-Slugs",
        'meta-tag-auditor': "überprüfen Sie Webseiten-Metadaten, kanonische Links und Viewport-Tags und erstellen Sie visuelle Social-Sharing-Karten",
      ...
      pt: {
        ...
        'social-hooks': "gere ganchos virais de alto engajamento para threads do Twitter/X, posts do LinkedIn ou roteiros do YouTube",
        'code-explainer': "explique scripts legados linha por linha ou traduza blocos de código entre linguagens de programação com anotações",
        'favicon-generator': "gere favicons multiplataforma (16x16, 32x32, 192x192, 512x512) e personalize especificações de webmanifest instantaneamente",
        'alt-text-generator': "audite imagens para gerar descrições de texto alternativo otimizadas para seo e acessibilidade",
        'keyword-difficulty': "calcule a dificuldade de pesquisa orgânica, a classificação de intenção de busca e as métricas de concorrentes de SERP simuladas",
        'url-slugifier': "converta títulos de postagens em slugs de URL limpos, focados em palavras-chave e otimizados para mecanismos de pesquisa",
        'meta-tag-auditor': "audite os metadados das páginas, links canônicos, configurações de viewport e gere cartões visuais para redes sociais",
