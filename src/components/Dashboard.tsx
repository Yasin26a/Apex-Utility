...
const DEFAULT_CARDS = [
  {
    id: 'webp-converter',
    title: 'Interactive WebP Converter',
    desc: 'Instantly read WebP vectors and convert to crisp PNG or compressed JPG quality locally.',
    tagline: '"convert webp to jpg instantly without registration"',
    category: 'Media Lab',
    categoryIcon: 'Image',
    cardIcon: 'Image',
