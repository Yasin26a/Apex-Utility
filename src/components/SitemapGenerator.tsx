...
const DISCOVERED_APP_TABS = [
  ...
  { tab: 'social-hooks', path: '/social-hooks', defaultPriority: 0.9, defaultFreq: 'weekly' },
  { tab: 'code-explainer', path: '/code-explainer', defaultPriority: 0.9, defaultFreq: 'weekly' },
  { tab: 'favicon-generator', path: '/favicon-generator', defaultPriority: 0.9, defaultFreq: 'weekly' },
  { tab: 'alt-text-generator', path: '/alt-text-generator', defaultPriority: 0.9, defaultFreq: 'weekly' },
  { tab: 'keyword-difficulty', path: '/keyword-difficulty', defaultPriority: 0.9, defaultFreq: 'weekly' },
  { tab: 'url-slugifier', path: '/url-slugifier', defaultPriority: 0.9, defaultFreq: 'weekly' },
  ...
  { tab: 'redirect-auditor', path: '/redirect-auditor', defaultPriority: 0.85, defaultFreq: 'weekly' },
  { tab: 'google-serp', path: '/google-serp', defaultPriority: 0.85, defaultFreq: 'weekly' },
  { tab: 'sql-formatter', path: '/sql-formatter', defaultPriority: 0.85, defaultFreq: 'weekly' },
  { tab: 'subnet-cidr', path: '/subnet-cidr', defaultPriority: 0.85, defaultFreq: 'weekly' },
  { tab: 'svg-wave', path: '/svg-wave', defaultPriority: 0.85, defaultFreq: 'weekly' },
  { tab: 'box-shadow', path: '/box-shadow', defaultPriority: 0.85, defaultFreq: 'weekly' },
  ...
  { tab: 'alt-text-generator', path: '/alt-text-generator', defaultPriority: 0.8, defaultFreq: 'weekly' },
  { tab: 'keyword-difficulty', path: '/keyword-difficulty', defaultPriority: 0.8, defaultFreq: 'weekly' },
  { tab: 'url-slugifier', path: '/url-slugifier', defaultPriority: 0.8, defaultFreq: 'weekly' },
